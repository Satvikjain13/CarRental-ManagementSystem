			...
			%>
				...
				<div class="row pt-2">
					<div class="col-md-3 col-6 mb-2">
						<i class="fa fa-car text-primary mr-2"></i> <span>Model: <%=rs.getInt("ModelYear")%></span>
					</div>
					<div class="col-md-3 col-6 mb-2">
						<i class="fa fa-cogs text-primary mr-2"></i> <span>Fuel
							Type : <%=rs.getString("FuelType")%></span>
					</div>
					<div class="col-md-3 col-6 mb-2">
						<i class="fa fa-road text-primary mr-2"></i> <span>Capacity
							: <%=rs.getInt("SeatingCapacity")%> Seat
						</span>
					</div>
					<div class="col-md-3 col-6 mb-2">
						<i class="fa fa-eye text-primary mr-2"></i> <span>Price : <%=rs.getFloat("PricePerDay")%></span>
					</div>
				</div>
				<div class="row mx-n2 mb-3">
					<div class="col-md-3 col-6 px-2 pb-2">
						<img class="img-fluid w-100"
							src="images1/<%=rs.getString("Vimage1")%>"
							style="width: 100%; height: 150px;">
					</div>
					<div class="col-md-3 col-6 px-2 pb-2">
						<img class="img-fluid w-100"
							src="images1/<%=rs.getString("Vimage2")%>"
							style="width: 100%; height: 150px;">
					</div>
					<div class="col-md-3 col-6 px-2 pb-2">
						<img class="img-fluid w-100"
							src="images1/<%=rs.getString("Vimage3")%>"
							style="width: 100%; height: 150px;">
					</div>
					<div class="col-md-3 col-6 px-2 pb-2">
						<img class="img-fluid w-100"
							src="images1/<%=rs.getString("Vimage4")%>"
							style="width: 100%; height: 150px;">
					</div>
				</div>
			...
			<div class="col-lg-4 mb-5">
				<form method="post">
					...
					<div class="bg-secondary p-5">
						...
						<div class="form-group">
							<textarea type="text" name="message" class="form-control p-4"
								placeholder="Message..." required></textarea>
						</div>
						<div class="form-group mb-0">
							<a href="user_login.jsp" class="btn btn-primary btn-block"
								style="height: 50px;">Login for Book</a>
						</div>
					</div>
				</form>
			</div>
