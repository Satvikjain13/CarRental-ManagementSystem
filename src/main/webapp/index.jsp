...
<%@include file="navbar.jsp" %>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Car Rental Portal</h4>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">Car Rental Portal </span></h1>
            ...
            <div class="row mt-3">
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">24/7 Car Rental Portal Support</h4>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
        ...
        <div class="container py-5">
            <div class="bg-banner py-5 px-4 text-center">
                <div class="py-5">
                    ...
                    <a class="btn btn-primary mt-2 py-3 px-5" href="{% url 'signup' %}">Register Now</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <%
                	try
				   {
					...
					ResultSet rs = st.executeQuery("SELECT vehicles.VehiclesTitle,brands.BrandName,vehicles.PricePerDay,vehicles.FuelType,vehicles.ModelYear,vehicles.id,vehicles.SeatingCapacity,vehicles.VehiclesOverview,vehicles.Vimage1 from vehicles join brands on brands.id=vehicles.VehiclesBrand");
					while(rs.next()) {						
                %>
                <div class="col-lg-4 col-md-6 mb-2">
                   <a href="carDetails.jsp?id=<%=rs.getInt("id") %>">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="images1/<%=rs.getString("Vimage1") %>" width="100%" height="150px">
                        <h4 class="text-uppercase mb-4"><%=rs.getString("VehiclesTitle") %></h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span><%=rs.getInt("ModelYear") %> Model</span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span><%=rs.getString("FuelType") %></span>
                            </div>
                            <div class="px-2">
                                <i class="fa fa-road text-primary mr-1"></i>
                                <span><%=rs.getInt("SeatingCapacity") %> Seater</span>
                            </div>
                        </div>
                        <a class="btn btn-primary px-3" href=""><%=rs.getFloat("PricePerDay") %> Rs./Day</a>
                    </div>
                   </a>
                </div>
                <%
