<%@include file="navbar.jsp" %>
		...
		%>
		   <script>
				alert("Contact Details has been send Successfully");
		   </script>
		<%
			}
		%>
                ...
                <div class="contact-form bg-light mb-4" style="padding: 30px;">
                    <form action="contact" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                <input type="email" name="EmailId" class="form-control p-4" placeholder="Your Email" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" name="ContactNumber" class="form-control p-4" placeholder="Your Contact Number" maxlength="10" required>
                        </div>
                        <div class="form-group">
